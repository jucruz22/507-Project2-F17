...
res = sample_get_cache_itunes_data("Lemony Snicket") # it worked! search results show up in cache file
media_sample = res["results"][0]
...
class Media(object):
    def __init__(self,media_dict):
        ...
        self.itunes_id = media_dict["collectionId"]
